    ...
    return (
        <div className="px-[19px] py-[17px]">
            <div className="font-montserrat">
                <h1 className="font-cerotta text-[12px] font-bold">
                    Detail Produk
                </h1>
                ...
                <p>
                    ...
                    <span className="text-[6px] text-[#00C838]">
                        {" "}
                        | Tersedia
                    </span>
                </p>
            ...
            <p>
                ...
                <p className="text-[12px] opacity-55 w-[95%] mt-[10px] text-justify">
                    ...
                    Nullam commodo justo in orci ullamcorper, a faucibus nisi
                    congue. Curabitur facilisis sem id nisl lacinia, vel
                    convallis lectus eleifend. Fusce vehicula felis sit amet
                    eros placerat, ac fermentum libero interdum. Pellentesque
                    non eros et odio hendrerit tristique.
                </p>
                ...
                <div className="mt-[25px] text-[10px] flex items-center h-[23px] gap-[16px]">
                    <div className="bg-[#BB8360] w-fit p-[2px] flex gap-[2px] rounded-[5px] h-full">
                        <span className="px-[7px] py-[2px] bg-white rounded-l-[2px]">
                            -
                        </span>
                        <span className="px-[7px] py-[2px] bg-white">1</span>
                        <span className="px-[7px] py-[2px] text-white">+</span>
                    </div>
